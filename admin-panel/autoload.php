...
<?php if ($page == 'create-article' || $page == 'edit-article' || $page == 'manage-announcements' || $page == 'newsletters' || $page == 'add-new-article' || $page == 'edit-article' || $page == 'edit-terms-pages') { ?>
...
<?php } ?>
    ...
    <![endif]-->
    <?php if ($page == 'bank-receipts' || $page == 'manage-verification-requests' || $page == 'manage-user-verification' || $page == 'manage-user-ads' || $page == 'manage-photos' || $page == 'manage-stickers') { ?>
        <!-- Css -->
            ...
            <div class="navigation-menu-body">
                <ul>
                    ...
                    if ($is_admin == true
                        ...
                        ?>
                    <li <?php echo ($page == 'general-settings' || $page == 'site-settings' || $page == 'video-settings' || $page == 'email-settings' || $page == 'social-login' || $page == 'site-features' || $page == 'amazon-settings' ||  $page == 'chat-settings' || $page == 'payment-settings') ? 'class="open"' : ''; ?>>
                        ...
                        <ul class="ml-menu">
                            ...
                            <li>
                                <a <?php echo ($page == 'chat-settings') ? 'class="active"' : ''; ?> href="<?php echo Wo_LoadAdminLinkSettings('chat-settings'); ?>">Chat Settings</a>
                            </li>
                            <?php } ?>
                    ...
                    <li <?php echo ($page == 'manage-verification-requests' || $page == 'manage-users' || $page == 'manage-verification-reqeusts' || $page == 'affiliates-settings' || $page == 'payment-requests' || $page == 'referrals-list' || $page == 'edit-user-permissions' || $page == 'manage-user-verification' || $page == 'manage-genders' || $page == 'add-genders' || $page == 'edit-genders' || $page == 'manage-profile-fields' || $page == 'add-new-profile-field' || $page == 'edit-profile-field' || $page == 'manage-success-stories' || $page == 'add-success-stories' || $page == 'edit-success-stories' || $page == 'manage-countries' || $page == 'add-countries' || $page == 'edit-countries') ? 'class="open"' : ''; ?>>
                        ...
                        <ul class="ml-menu">
                            ...
                            <li>
                                <a <?php echo ($page == 'manage-users' || $page == 'edit-user-permissions') ? 'class="active"' : ''; ?> href="<?php echo Wo_LoadAdminLinkSettings('manage-users'); ?>">Manage Users</a>
                            </li>
                            <?php }?>
                            <?php if($is_admin == true || CheckRadioPermission($current_user_id, "manage-genders")){ ?>
                            <li>
                                <a <?php echo ($page == 'manage-genders' || $page == 'add-genders' || $page == 'edit-genders') ? 'class="active"' : ''; ?> href="<?php echo Wo_LoadAdminLinkSettings('manage-genders'); ?>">Manage Genders</a>
                            </li>
                            <?php }?>
                            <?php if($is_admin == true || CheckRadioPermission($current_user_id, "manage-countries")){ ?>
                                <li>
                                    <a <?php echo ($page == 'manage-countries' || $page == 'add-countries' || $page == 'edit-countries') ? 'class="active"' : ''; ?> href="<?php echo Wo_LoadAdminLinkSettings('manage-countries'); ?>">Manage Countries</a>
                                </li>
                            <?php }?>
                            <?php if($is_admin == true || CheckRadioPermission($current_user_id, "manage-profile-fields")){ ?>
                            <li>
                                <a <?php echo ($page == 'manage-profile-fields' || $page == 'add-new-profile-field' || $page == 'edit-profile-field') ? 'class="active"' : ''; ?> href="<?php echo Wo_LoadAdminLinkSettings('manage-profile-fields'); ?>">Manage Custom Profile Fields</a>
                            </li>
                            <?php }?>
                            <?php if($is_admin == true || CheckRadioPermission($current_user_id, "manage-success-stories")){ ?>
                            <li>
                                <a <?php echo ($page == 'manage-success-stories' || $page == 'add-success-stories' || $page == 'edit-success-stories') ? 'class="active"' : ''; ?> href="<?php echo Wo_LoadAdminLinkSettings('manage-success-stories'); ?>">Manage success stories</a>
                            </li>
                            <?php }?>
                            <?php if($is_admin == true || CheckRadioPermission($current_user_id, "manage-user-verification")){ ?>
                            <li>
                                <a <?php echo ($page == 'manage-user-verification') ? 'class="active"' : ''; ?> href="<?php echo Wo_LoadAdminLinkSettings('manage-user-verification'); ?>">Manage user verification</a>
                            </li>
                            <?php }?>
                            <?php if($is_admin == true || CheckRadioPermission($current_user_id, "manage-verification-requests")){ ?>
                                <li>
                                    <a <?php echo ($page == 'manage-verification-requests') ? 'class="active"' : ''; ?> href="<?php echo Wo_LoadAdminLinkSettings('manage-verification-requests'); ?>">Manage user verification requests</a>
                                </li>
                            <?php }?>
                            ...
                            <?php if($is_admin == true || CheckRadioPermission($current_user_id, "affiliates-settings") || CheckRadioPermission($current_user_id, "payment-requests")){ ?>
                                <li>
                                    ...
                                    <ul class="ml-menu">
                                        ...
                                        <li>
                                            <a <?php echo ($page == 'payment-requests' || $page == 'referrals-list') ? 'class="active"' : ''; ?> href="<?php echo Wo_LoadAdminLinkSettings('payment-requests'); ?>">
                    ...
                    <li <?php echo ( $page == 'manage-payments' || $page == 'payments' || $page == 'bank-receipts' ) ? 'class="open"' : ''; ?>>
                        <a href="javascript:void(0);">
                            <span class="nav-link-icon">
                        ...
                        <ul class="ml-menu">
                            ...
                            <li>
                                <a <?php echo ($page == 'payments') ? 'class="active"' : ''; ?> href="<?php echo Wo_LoadAdminLinkSettings('payments'); ?>">Payments</a>
                            </li>
                            <?php } ?>
                            <?php if ($is_admin == true || CheckUserPermission($current_user_id, "manage-payments")) { ?>
                            <li>
                                <a <?php echo ($page == 'manage-payments') ? 'class="active"' : ''; ?> href="<?php echo Wo_LoadAdminLinkSettings('manage-payments'); ?>">Manage Payments</a>
                            </li>
                            <?php } ?>
                            <?php if ($is_admin == true || CheckUserPermission($current_user_id, "bank-receipts")) { ?>
                            <li>
                                <a <?php echo ($page == 'bank-receipts') ? 'class="active"' : ''; ?> href="<?php echo Wo_LoadAdminLinkSettings('bank-receipts'); ?>">Manage bank receipts</a>
                            </li>
                            <?php } ?>
                        </ul>
                    </li>
                    ...
                    <li <?php echo ($page == 'manage-photos' ) ? 'class="open"' : ''; ?>>
                        ...
                        <ul class="ml-menu">
                            <li>
                                <a <?php echo ($page == 'manage-photos') ? 'class="active"' : ''; ?> href="<?php echo Wo_LoadAdminLinkSettings('manage-photos'); ?>">Manage Photos & Videos</a>
                            </li>
                        </ul>
                    </li>
                    <?php }?>
                    ...
                    <li <?php echo ($page == 'manage-stickers' || $page == 'add-new-sticker' ) ? 'class="open"' : ''; ?>>
                        ...
                        <ul class="ml-menu">
                            ...
                            <li>
                                <a <?php echo ($page == 'manage-stickers') ? 'class="active"' : ''; ?> href="<?php echo Wo_LoadAdminLinkSettings('manage-stickers'); ?>">Manage stickers</a>
                            </li>
                            <?php } ?>
                    ...
                    <li <?php echo ($page == 'manage-articles' || $page == 'add-new-article' || $page == 'manage-blog-categories' || $page == 'edit-article') ? 'class="open"' : ''; ?>>
                        ...
                        <ul class="ml-menu">
                            ...
                            <li>
                                <a <?php echo ($page == 'manage-articles' || $page == 'edit-article') ? 'class="active"' : ''; ?> href="<?php echo Wo_LoadAdminLinkSettings('manage-articles'); ?>">Manage Blog</a>
                            </li>
                            <?php } ?>
                            <?php if ($is_admin == true || CheckUserPermission($current_user_id, "manage-blog-categories")) { ?>
                            <li>
                                <a <?php echo ($page == 'manage-blog-categories') ? 'class="active"' : ''; ?> href="<?php echo Wo_LoadAdminLinkSettings('manage-blog-categories'); ?>">Blog categories</a>
                            </li>
                            <?php } ?>
                            <?php if ($is_admin == true || CheckUserPermission($current_user_id, "add-new-article")) { ?>
                            <li>
                                <a <?php echo ($page == 'add-new-article') ? 'class="active"' : ''; ?> href="<?php echo Wo_LoadAdminLinkSettings('add-new-article'); ?>">
                                    Add New article
                                </a>
                            </li>
                            <?php } ?>
                    ...
                    <li <?php echo ($page == 'manage-gifts' || $page == 'add-new-gift' ) ? 'class="open"' : ''; ?>>
                        ...
                        <ul class="ml-menu">
                            ...
                            <li>
                                <a <?php echo ($page == 'manage-gifts') ? 'class="active"' : ''; ?> href="<?php echo Wo_LoadAdminLinkSettings('manage-gifts'); ?>">Manage gifts</a>
                            </li>
                            <?php } ?>
                    ...
                    <li <?php echo ( $page == 'manage-website-ads') ? 'class="open"' : ''; ?>>
                        <a href="javascript:void(0);">
                            <span class="nav-link-icon">
                        ...
                        <ul class="ml-menu">
                            <li>
                                <a <?php echo ($page == 'manage-website-ads') ? 'class="active"' : ''; ?> href="<?php echo Wo_LoadAdminLinkSettings('manage-website-ads'); ?>">Manage Website Ads</a>
                            </li>
                        </ul>
                    </li>
                    <?php }?>
                    ...
                    <li <?php echo ($page == 'manage-themes' || $page == 'change-site-desgin' || $page == 'custom-design') ? 'class="open"' : ''; ?>>
                        ...
                        <ul class="ml-menu">
                            ...
                            <li>
                                <a <?php echo ($page == 'change-site-desgin') ? 'class="active"' : ''; ?> href="<?php echo Wo_LoadAdminLinkSettings('change-site-desgin'); ?>">Change Site Design</a>
                            </li>
                            <?php } ?>
                    ...
                    <li <?php echo ($page == 'fake-users' || $page == 'manage-announcements' || $page == 'ban-users' || $page == 'mock-email' ) ? 'class="open"' : ''; ?>>
                        <a href="javascript:void(0);">
                            <span class="nav-link-icon">
                        ...
                        <ul class="ml-menu">
                            ...
                            <?php if ($is_admin == true || CheckUserPermission($current_user_id, "mock-email")) { ?>
                                <li>
                                    <a <?php echo ($page == 'mock-email') ? 'class="active"' : ''; ?> href="<?php echo Wo_LoadAdminLinkSettings('mock-email'); ?>">Send E-mail</a>
                                </li>
                            <?php } ?>
                        </ul>
                    </li>
                    ...
                    <li <?php echo ($page == 'manage-languages' || $page == 'add-language' || $page == 'edit-lang') ? 'class="open"' : ''; ?>>
                        ...
                        <ul class="ml-menu">
                            ...
                            <li>
                                <a <?php echo ($page == 'manage-languages') ? 'class="active"' : ''; ?> href="<?php echo Wo_LoadAdminLinkSettings('manage-languages'); ?>">Manage Languages</a>
                            </li>
                            <?php } ?>
                        </ul>
                    </li>
                    ...
                    <li <?php echo ($page == 'edit-terms-pages' || $page == 'manage-custom-pages' || $page == 'add-new-custom-page' || $page == 'edit-custom-page' ) ? 'class="open"' : ''; ?>>
                        ...
                        <ul class="ml-menu">
                            ...
                            <li>
                                <a <?php echo ($page == 'manage-custom-pages' || $page == 'add-new-custom-page' || $page == 'edit-custom-page') ? 'class="active"' : ''; ?> href="<?php echo Wo_LoadAdminLinkSettings('manage-custom-pages'); ?>">Manage Custom Pages</a>
                            </li>
                            <?php } ?>
                            ...
                            <?php if ($is_admin == true ) { ?>
                            <li>
                                <a <?php echo ($page == 'pages-seo') ? 'class="active"' : ''; ?> href="<?php echo Wo_LoadAdminLinkSettings('pages-seo'); ?>">Pages SEO</a>
                            </li>
                            <?php } ?>
                        </ul>
                    </li>
