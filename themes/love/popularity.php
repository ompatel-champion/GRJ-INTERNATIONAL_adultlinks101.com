	...
	<div class="row r_margin">
		...
		<div class="col l9">
			...
			<div class="dt_credits dt_sections">
				<h4 class="bold">
					<svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24"><path fill="currentColor" d="M12,17.27L18.18,21L16.54,13.97L22,9.24L14.81,8.62L12,2L9.19,8.62L2,9.24L7.45,13.97L5.82,21L12,17.27Z"></path></svg> <?php echo __('Popularity');?>
				</h4>
				<div class="qd_cred_bl">
					...
					<h2><span><?php echo GetUserPopularity($profile->id);?></span> <?php echo __('Popularity');?></h2>
					<p><?php echo __('Increase your Popularity with Credits and enjoy the features.');?></p>
				</div>
			</div>
			<div class="dt_credits dt_sections">
				<h4 class="bold">
					<svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24"><path fill="currentColor" d="M13,18V10L16.5,13.5L17.92,12.08L12,6.16L6.08,12.08L7.5,13.5L11,10V18H13M12,2A10,10 0 0,1 22,12A10,10 0 0,1 12,22A10,10 0 0,1 2,12A10,10 0 0,1 12,2Z"></path></svg> <?php echo __('Increase Popularity');?>
				</h4>
				<div class="row dt_pro_features dt_popular">
					<div class="col s12" id="buy_more_visits">
						<div class="valign-wrapper dt_poplrity_cont visits">
							...
							<div class="dt_pop_mdl">
								<h2><?php echo __('Increase');?> 10x <?php echo __('visits');?></h2>
							</div>
					...
					<div class="col s12" id="buy_more_matches">
						<div class="valign-wrapper dt_poplrity_cont matches">
							<div class="dt_pop_hdr">
								<div class="dt_pop_icn">
									<span>
							...
							<div class="dt_pop_mdl">
								<h2><?php echo __('Increase');?> 3x <?php echo __('matches');?></h2>
							</div>
							<div class="dt_pop_ftr">
					...
					<div class="col s12" id="buy_more_likes">
						<div class="valign-wrapper dt_poplrity_cont likes">
							<div class="dt_pop_hdr">
								<div class="dt_pop_icn">
									<span>
							...
							<div class="dt_pop_mdl">
								<h2><?php echo __('Increase');?> 4x <?php echo __('likes');?></h2>
							</div>
							<div class="dt_pop_ftr">
