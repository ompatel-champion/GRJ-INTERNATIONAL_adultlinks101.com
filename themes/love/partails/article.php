...
<div class="col l4 m6">
	<div class="dt_sections articles qd_blog_lists">
		...
		<div class="qd_blog_list_info">
			<h5><a href="<?php echo $site_url;?>/article/<?php echo $article->id . '_' . url_slug(html_entity_decode($article->title));?>" data-ajax="/article/<?php echo $article->id . '_' . url_slug(html_entity_decode($article->title));?>"><?php echo $article->title;?></a></h5>
