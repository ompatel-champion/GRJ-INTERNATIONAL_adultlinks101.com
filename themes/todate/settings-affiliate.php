	...
	<div class="col m12 l8">
		<div class="dt_settings dt_usr_affl">
			...
			<div class="delete_acc">
                <p class="center"><a class="btn btn-small waves-effect waves-light btn_primary btn_round" href="<?php echo $site_url;?>/settings-payments/<?php echo $profile->username;?>" data-ajax="/settings-payments/<?php echo $profile->username;?>"><?php echo __('Request withdrawal');?></a></p>
                <hr class="border_hr">
            </div>
