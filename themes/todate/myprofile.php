    ...
    <div class="row r_margin">
        ...
        <div class="col s12 l7">
			...
			<div class="dt_user_profile dt_user_info">
				<div class="info">
					<div class="combo">
						<h2><?php echo $profile->full_name;?><?php echo ( $profile->age  > 0 ) ? ", ". $profile->age : "";?>
				...
				<div class="dt_cp_photos_list">
					<div class="dt_cp_bar_add_photos" onclick="document.getElementById('avatar_profileimg').click(); return false"> <!-- Add Photo -->
						<div class="inline">
							<span>
								<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"><path d="M11 11V5h2v6h6v2h-6v6h-2v-6H5v-2z" fill="currentColor"/></svg>
